(function() {
    function e(e) {
        ...
        this.rules = o.normal,
        this.options.gfm && (this.options.tables ? this.rules = o.tables: this.rules = o.gfm)
    }
    function t(e, t) {
    ...
    o.bullet = /(?:[*+-]|\d+\.)/,
    o.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/,
    o.item = r(o.item, "gm")(/bull/g, o.bullet)(),
    o.list = r(o.list)(/bull/g, o.bullet)("hr", /\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)(),
    o._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|@)\\b",
    o.html = r(o.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, o._tag)(),
    o.paragraph = r(o.paragraph)("hr", o.hr)("heading", o.heading)("lheading", o.lheading)("blockquote", o.blockquote)("tag", "<" + o._tag)("def", o.def)(),
    o.normal = a({},
    o),
    o.gfm = a({},
    o.normal, {
    ...
    o.gfm.paragraph = r(o.paragraph)("(?!", "(?!" + o.gfm.fences.source.replace("\\1", "\\2") + "|")(),
    o.tables = a({},
    o.gfm, {
        nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
        table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
    ...
    e.prototype.token = function(e, t) {
        for (var n, s, r, i, a, l, h, c, u, e = e.replace(/^ +$/gm, ""); e;) if ((r = this.rules.newline.exec(e)) && (e = e.substring(r[0].length), r[0].length > 1 && this.tokens.push({
            type: "space"
        })), r = this.rules.code.exec(e)) e = e.substring(r[0].length),
        r = r[0].replace(/^ {4}/gm, ""),
        this.tokens.push({
            type: "code",
            text: this.options.pedantic ? r: r.replace(/\n+$/, "")
        });
        else if (r = this.rules.fences.exec(e)) e = e.substring(r[0].length),
        this.tokens.push({
            type: "code",
            lang: r[2],
            text: r[3]
        });
        else if (r = this.rules.heading.exec(e)) e = e.substring(r[0].length),
        this.tokens.push({
            type: "heading",
            depth: r[1].length,
            text: r[2]
            ...
            this.tokens.push(l)
        } else if (r = this.rules.lheading.exec(e)) e = e.substring(r[0].length),
        this.tokens.push({
            type: "heading",
            depth: "=" === r[2] ? 1 : 2,
            text: r[1]
        });
        else if (r = this.rules.hr.exec(e)) e = e.substring(r[0].length),
        this.tokens.push({
            type: "hr"
        });
        else if (r = this.rules.blockquote.exec(e)) e = e.substring(r[0].length),
        this.tokens.push({
        ...
        this.tokens.push({
            ...
            }), r = r[0].match(this.rules.item), this.options.smartLists && (i = o.bullet.exec(r[0])[0]), n = !1, u = r.length, c = 0; u > c; c++) l = r[c],
            h = l.length,
            l = l.replace(/^ *([*+-]|\d+\.) +/, ""),
            ~l.indexOf("\n ") && (h -= l.length, l = this.options.pedantic ? l.replace(/^ {1,4}/gm, "") : l.replace(new RegExp("^ {1," + h + "}", "gm"), "")),
            this.options.smartLists && c !== u - 1 && (a = o.bullet.exec(r[c + 1])[0], i === a || "." === i[1] && "." === a[1] || (e = r.slice(c + 1).join("\n") + e, c = u - 1)),
            s = n || /\n\n(?!\s*$)/.test(l),
            c !== u - 1 && (n = "\n" === l[l.length - 1], s || (s = n)),
            this.tokens.push({
        ...
        } else if (r = this.rules.html.exec(e)) e = e.substring(r[0].length),
        this.tokens.push({
            type: this.options.sanitize ? "paragraph": "html",
            pre: "pre" === r[1],
            text: r[0]
        });
        else if (t && (r = this.rules.def.exec(e))) e = e.substring(r[0].length),
        this.tokens.links[r[1].toLowerCase()] = {
            ...
            this.tokens.push(l)
        } else if (t && (r = this.rules.paragraph.exec(e))) e = e.substring(r[0].length),
        this.tokens.push({
            type: "paragraph",
            text: "\n" === r[1][r[1].length - 1] ? r[1].slice(0, -1) : r[1]
        });
        else if (r = this.rules.text.exec(e)) e = e.substring(r[0].length),
        this.tokens.push({
            type: "text",
            text: r[0]
        });
    ...
    h._inside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/,
    h._href = /\s*<?([^\s]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/,
    h.link = r(h.link)("inside", h._inside)("href", h._href)(),
    h.reflink = r(h.reflink)("inside", h._inside)(),
    h.normal = a({},
    h),
    h.pedantic = a({},
    h.normal, {
    ...
    t.prototype.output = function(e) {
        ...
        "@" === i[2] ? (n = ":" === i[1][6] ? this.mangle(i[1].substring(7)) : this.mangle(i[1]), r = this.mangle("mailto:") + n) : (n = s(i[1]), r = n),
        a += '<a href="' + r + '">' + n + "</a>";
        else if (i = this.rules.url.exec(e)) e = e.substring(i[0].length),
        n = s(i[1]),
        r = n,
        a += '<a href="' + r + '">' + n + "</a>";
        else if (i = this.rules.tag.exec(e)) e = e.substring(i[0].length),
        a += this.options.sanitize ? s(i[0]) : i[0];
        ...
        a += "<strong>" + this.output(i[2] || i[1]) + "</strong>";
        else if (i = this.rules.em.exec(e)) e = e.substring(i[0].length),
        a += "<em>" + this.output(i[2] || i[1]) + "</em>";
    ...
    n.prototype.tok = function() {
        ...
        case "code":
            ...
            return this.token.escaped || (this.token.text = s(this.token.text, !0)),
            "<pre><code" + (this.token.lang ? ' class="' + this.options.langPrefix + this.token.lang + '"': "") + ">" + this.token.text + "</code></pre>\n";
        case "table":
            var t, n, r, i, a, l = "";
            for (l += "<thead>\n<tr>\n", n = 0; n < this.token.header.length; n++) t = this.inline.output(this.token.header[n]),
            l += this.token.align[n] ? '<th align="' + this.token.align[n] + '">' + t + "</th>\n": "<th>" + t + "</th>\n";
            for (l += "</tr>\n</thead>\n", l += "<tbody>\n", n = 0; n < this.token.cells.length; n++) {
                for (r = this.token.cells[n], l += "<tr>\n", a = 0; a < r.length; a++) i = this.inline.output(r[a]),
                l += this.token.align[a] ? '<td align="' + this.token.align[a] + '">' + i + "</td>\n": "<td>" + i + "</td>\n";
                l += "</tr>\n"
            }
            return l += "</tbody>\n",
            "<table>\n" + l + "</table>\n";
        case "blockquote_start":
            ...
            return "<blockquote>\n" + l + "</blockquote>\n";
        case "list_start":
            for (var o = this.token.ordered ? "ol": "ul", l = "";
    ...
    l.lexer = e.lex,
    l.InlineLexer = t,
    l.inlineLexer = t.output,
    l.parse = l,
    "object" == typeof exports ? module.exports = l: "function" == typeof define && define.amd ? define(function() {
        return l
    }) : this.marked = l
}).call(function() {
...
function() {
    function e(e) {
        function t(e) {
            ...
            var n = e.charAt(1);
            return t = u[n],
            t ? t: n >= "0" && "7" >= n ? parseInt(e.substring(1), 8) : "u" === n || "x" === n ? parseInt(e.substring(2), 16) : e.charCodeAt(1)
        }
        function n(e) {
        ...
        function s(e) {
            ...
            for (var l = i ? 1 : 0, o = s.length; o > l; ++l) {
                var h = s[l];
                if (/\\[bdsw]/i.test(h)) a.push(h);
                else {
                    var c, u = t(h);
                    o > l + 2 && "-" === s[l + 1] ? (c = t(s[l + 2]), l += 2) : c = u,
                    r.push([u, c]),
                    65 > c || u > 122 || (65 > c || u > 90 || r.push([32 | Math.max(65, u), 32 | Math.min(c, 90)]), 97 > c || u > 122 || r.push([ - 33 & Math.max(97, u), -33 & Math.min(c, 122)]))
                }
            }
            r.sort(function(e, t) {
            ...
            for (var l = 0; l < p.length; ++l) {
                var g = p[l];
                a.push(n(g[0])),
                g[1] > g[0] && (g[1] + 1 > g[0] && a.push("-"), a.push(n(g[1])))
            }
            return a.push("]"),
            a.join("")
        }
        function r(e) {
            ...
            if (e.ignoreCase && a) for (var o = 0; r > o; ++o) {
                var c = t[o],
                p = c.charAt(0);
                c.length >= 2 && "[" === p ? t[o] = s(c) : "\\" !== p && (t[o] = c.replace(/[a-zA-Z]/g,
                function(e) {
                    var t = e.charCodeAt(0);
    ...
    function t(e, t) {
        function n(e) {
            ...
            case 1:
                ...
                var h = e.nodeName.toLowerCase(); ("br" === h || "li" === h) && (r[l] = "\n", a[l << 1] = i++, a[l++<<1 | 1] = e);
                break;
            case 3:
            case 4:
                var c = e.nodeValue;
    ...
    function n(e, t, n, s) {
        if (t) {
            ...
            n(r),
            s.push.apply(s, r.decorations)
        }
    }
    function s(e) {
        for (var t = void 0,
        n = e.firstChild; n; n = n.nextSibling) {
            var s = n.nodeType;
    ...
    function r(t, s) {
        var r, i = {}; !
        function() {
            for (var n = t.concat(s), a = [], l = {},
            o = 0, h = n.length; h > o; ++o) {
                var c = n[o],
                u = c[3];
        ...
        var a = s.length,
        l = function(e) {
            for (var t = e.sourceCode,
            o = e.basePos,
            c = [o, q], u = 0, p = t.match(r) || [], d = {},
            g = 0, f = p.length; f > g; ++g) {
                var m, b = p[g],
                x = d[b],
                v = void 0;
                if ("string" == typeof x) m = !1;
                else {
                    var y = i[b.charAt(0)];
                    if (y) v = b.match(y[1]),
                    x = y[0];
                    ...
                    m = x.length >= 5 && "lang-" === x.substring(0, 5),
                    !m || v && "string" == typeof v[1] || (m = !1, x = B),
                    m || (d[b] = x)
                }
                var w = u;
                if (u += b.length, m) {
                    ...
                    var E = x.substring(5);
                    n(o + w, b.substring(0, _), l, c),
                    n(o + w + _, S, h(E, S), c),
                    n(o + w + C, b.substring(C), l, c)
                } else c.push(o + w, x)
            }
            e.decorations = c
        };
    ...
    function i(e) {
        ...
        l.length && n.push([T, new RegExp("^(?:" + l.replace(/[\s,]+/g, "|") + ")\\b"), null]),
        t.push([q, /^\s+/, null, " \r\n	 "]);
        var o = /^.[^\s\w\.$@\'\"\`\/\\]*/;
        return n.push([A, /^@[a-z_$][a-z_$@0-9]*/i, null], [j, /^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/, null], [q, /^[a-z_$][a-z_$@0-9]*/i, null], [A, new RegExp("^(?:0x[a-f0-9]+|(?:\\d(?:_\\d+)*\\d*(?:\\.\\d*)?|\\.\\d\\+)(?:e[+\\-]?\\d+)?)[a-z]*", "i"), null, "0123456789"], [q, /^\\[\s\S]?/, null], [P, o, null]),
        r(t, n)
    }
    function a(e, t, n) {
        function s(e) {
            ...
            case 1:
                ...
                if ("br" === e.nodeName) r(e),
                e.parentNode && e.parentNode.removeChild(e);
                else for (var t = e.firstChild; t; t = t.nextSibling) s(t);
                break;
            case 3:
            case 4:
                if (n) {
        ...
        function r(e) {
            function t(e, n) {
                var s = n ? e.cloneNode(!1) : e,
                r = e.parentNode;
                if (r) {
                    var i = t(r, 1),
                    a = e.nextSibling;
                    i.appendChild(s);
                    for (var l = a; l; l = a) a = l.nextSibling,
                    i.appendChild(l)
                }
                return s
            }
        ...
        a = /\r\n?|\n/,
        l = e.ownerDocument,
        o = l.createElement("li"); e.firstChild;) o.appendChild(e.firstChild);
        for (var h = [o], c = 0; c < h.length; ++c) s(h[c]);
        t === (0 | t) && h[0].setAttribute("value", t);
        var u = l.createElement("ol");
        u.className = "linenums";
        for (var p = Math.max(0, t - 1 | 0) || 0, c = 0, d = h.length; d > c; ++c) o = h[c],
        o.className = "L" + (c + p) % 10,
        ...
        try {
            for (; l > o;) {
                ...
                if (1 !== w.nodeType && (v = s.substring(i, m))) {
                    ...
                    C.replaceChild(_, w),
                    _.appendChild(w),
                    y > i && (a[o + 1] = w = S.createTextNode(s.substring(m, y)), C.insertBefore(w, _.nextSibling))
                }
                i = m,
                i >= y && (o += 2),
                i >= k && (u += 2)
    ...
    function p(e) {
        ...
        function n() {
            for (var t = d.PR_SHOULD_USE_CONTINUATION ? u.now() + 250 : 1 / 0; g < i.length && u.now() < t; g++) {
                ...
                if (m.test(l) && !b.test(l)) {
                    for (var o = !1,
                    h = r.parentNode; h; h = h.parentNode) {
                        var k = h.tagName;
                    ...
                    if (!o) {
                        ...
                        var w, S = l.match(f); ! S && (w = s(r)) && v.test(w.tagName) && (S = w.className.match(f)),
                        S && (S = S[1]);
                        var _;
                        if (x.test(r.tagName)) _ = 1;
                        else {
        ...
        for (var r = [t("pre"), t("code"), t("xmp")], i = [], l = 0; l < r.length; ++l) for (var o = 0,
        h = r[l].length; h > o; ++o) i.push(r[l][o]);
        r = null;
        var u = Date;
        u.now || (u = {
            now: function() {
    ...
    C = [g, "case,done,elif,esac,eval,fi,function,in,local,set,then,until"],
    E = [b, v, k, w + S, _, C],
    ...
    U = {};
    o(F, ["default-code"]),
    o(r([], [[q, /^[^<?]+/], [R, /^<!\w[^>]*(?:>|$)/], [L, /^<\!--[\s\S]*?(?:-\->|$)/], ["lang-", /^<\?([\s\S]+?)(?:\?>|$)/], ["lang-", /^<%([\s\S]+?)(?:%>|$)/], [P, /^(?:<[%?]|[%?]>)/], ["lang-", /^<xmp\b[^>]*>([\s\S]+?)<\/xmp\b[^>]*>/i], ["lang-js", /^<script\b[^>]*>([\s\S]*?)(<\/script\b[^>]*>)/i], ["lang-css", /^<style\b[^>]*>([\s\S]*?)(<\/style\b[^>]*>)/i], ["lang-in.tag", /^(<\/?[a-z][^<>]*>)/i]]), ["default-markup", "htm", "html", "mxml", "xhtml", "xml", "xsl"]),
    o(r([[q, /^[\s]+/, null, " 	\r\n"], [O, /^(?:\"[^\"]*\"?|\'[^\']*\'?)/, null, "\"'"]], [[M, /^^<\/?[a-z](?:[\w.:-]*\w)?|\/?>$/i], [I, /^(?!style[\s=]|on)[a-z](?:[\w:-]*\w)?/i], ["lang-uq.val", /^=\s*([^>\'\"\s]*(?:[^>\'\"\s\/]|\/(?=\s)))/], [P, /^[=<>\/]+/], ["lang-js", /^on\w+\s*=\s*\"([^\"]+)\"/i], ["lang-js", /^on\w+\s*=\s*\'([^\']+)\'/i], ["lang-js", /^on\w+\s*=\s*([^\"\'>\s]+)/i], ["lang-css", /^style\s*=\s*\"([^\"]+)\"/i], ["lang-css", /^style\s*=\s*\'([^\']+)\'/i], ["lang-css", /^style\s*=\s*([^\"\'>\s]+)/i]]), ["in.tag"]),
    o(r([], [[O, /^[\s\S]+/]]), ["uq.val"]),
    o(i({
        keywords: b,
        hashComments: !0,
...
function(e, t) {
    function n(e) {
        var n, s, r, i = t.createElement("a"),
        a = {};
        for (i.href = e, n = i.search.replace("?", "&").split("&"), r = 0; r < n.length; r++) s = n[r].split("="),
        s[0] && (a[s[0]] = s[1] || "");
        return a
    }
    t.body.style.display = "none",
    t.head = t.getElementsByTagName("head")[0],
    "getElementsByClassName" in t || (t.getElementsByClassName = function(e) {
        function n(e, t) {
    ...
    a = t.getElementsByClassName("navbar")[0],
    l = t.createElement("meta");
    l.name = "viewport",
    l.content = "width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0",
    t.head.firstChild ? t.head.insertBefore(l, t.head.firstChild) : t.head.appendChild(l);
    for (var o = "",
    h = 0; h < i.length; h++) i[h].src.match("strapdown") && (o = i[h].src);
    var c = o.substr(0, o.lastIndexOf("/")),
    u = n(o);
    console.log(u),
    console.log("[strapdown.js] [INFO] search the URI for src = " + u.src);
    var p = s.getAttribute("theme") || u.theme || "united";
    p = p.toLowerCase(),
    console.log("[strapdown.js] [INFO] Parser and lexer well imported. Origin = " + o + "\n Theme = " + p);
    var g = s.textContent || s.innerText,
    f = t.createElement("article");
    f.id = "content",
    t.body.replaceChild(f, s);
    var f = t.createElement("div");
    marked.setOptions({
        gfm: !0,
        tables: !0,
        smartypants: !0,
        pedantic: u.pedantic || !1
    });
    var x = marked(g);
    ...
    if (C.type = "text/x-mathjax-config", C.innerHTML = "MathJax.Hub.Config({ tex2jax: { inlineMath: [['$','$']], displayMath: [ ['$$','$$']], processEscapes: true } });", t.body.appendChild(C), u.mathjax) {
        ...
        C.src = "https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS_HTML&amp;locale=fr",
        t.head.appendChild(C)
    }
    if (u.beacon) {
        var d = t.createElement("img");
        d.alt = "GA|Analytics",
        d.style = "visibility: hidden; display: none;",
        d.src = "http://perso.crans.org/besson/beacon/14/query/strapdown.js?pixel",
